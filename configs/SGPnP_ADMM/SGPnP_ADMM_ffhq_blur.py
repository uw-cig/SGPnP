...
params = {
    ...
    "hyperparam1": 1.32,                            # Data consistency step size
    "hyperparam2": 0.,                            # Prior step size
    "pnp_method": "sgpnp_admm",
    "kernel_index": 0, 
    "pnp_iters": 50, 
    "sigma_cond_0": 5.,                            # for classical PnP methods like DPIR, IRCNN
    "sigma_cond_K": 0.02,                           # for classical PnP methods like DPIR, IRCNN
    "sigma_inject_0": 5.,                           # for classical PnP methods like DPIR, IRCNN
