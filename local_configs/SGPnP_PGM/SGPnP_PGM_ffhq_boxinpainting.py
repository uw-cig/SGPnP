...
params = {
    ...
    "inverse_problem_type": 'box_inpainting',     # ['box_inpainting', 'random_inpainting', 'blur', 'super_resolution]
    ...
    "hyperparam1": 0.22,                            # Data consistency step size
    "hyperparam2": 0.4,                            # Prior step size
